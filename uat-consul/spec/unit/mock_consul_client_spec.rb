describe UAT::Consul::MockClient do
  ...
  subject { UAT::Consul::MockClient.new hash_of_service_urls_keyed_by_service_name, api }
  describe '#new()' do
    it 'creates a new instance' do
      expect(subject).to be_a UAT::Consul::MockClient
    end
  end
